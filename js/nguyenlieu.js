...
const KHO_MAC_DINH = [
    { id: 'nl_cf', name: 'Cốt Cà phê', stock: 2000, unit: 'ml' },
    { id: 'nl_matcha_dai', name: 'Matcha Đài', stock: 500, unit: 'g' },
    { id: 'nl_matcha_mk4', name: 'Matcha MK4', stock: 500, unit: 'g' },
    { id: 'nl_cacao', name: 'Bột Cacao', stock: 500, unit: 'g' },
    { id: 'nl_khoaimon', name: 'Bột Khoai môn', stock: 500, unit: 'g' },
    { id: 'nl_suadac', name: 'Sữa Đặc', stock: 2000, unit: 'ml' },
    { id: 'nl_sua_mlekovita', name: 'Sữa Mlekovita', stock: 2000, unit: 'ml' },
    { id: 'nl_sua_oatside', name: 'Sữa Oatside', stock: 2000, unit: 'ml' },
    { id: 'nl_rich', name: 'Rich Lùn', stock: 1000, unit: 'ml' },
    { id: 'nl_duong', name: 'Đường', stock: 2000, unit: 'ml' },
    { id: 'nl_kemmuoi', name: 'Kem Muối', stock: 500, unit: 'ml' },
    ...
    { id: 'nl_tc_den', name: 'Trân châu đen', stock: 500, unit: 'g' },
    { id: 'nl_tc_3q', name: 'Trân châu 3Q', stock: 500, unit: 'g' },
    { id: 'nl_cunang', name: 'Thạch củ năng', stock: 500, unit: 'g' },
    { id: 'nl_daomieng', name: 'Đào miếng', stock: 500, unit: 'miếng' },
    { id: 'nl_vaimieng', name: 'Vải Miếng', stock: 500, unit: 'miếng' },
    { id: 'nl_thachcf', name: 'Thạch cà phê', stock: 500, unit: 'g' },
    ...
    { id: 'nl_chunkyvai', name: 'ChunKy Vải Hoa Hồng', stock: 1000, unit: 'ml' },
